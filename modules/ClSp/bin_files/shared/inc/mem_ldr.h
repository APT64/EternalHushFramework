...
unsigned int default_hashfunc(char* str, unsigned int len);
...
#define GET_HEADER_DICTIONARY(module, idx)  &(module)->headers->OptionalHeader.DataDirectory[idx]
     ...
     * ordinal value.
     */
    FARPROC MemoryGetProcAddress(PMEMORYMODULE, DWORD32 hash);
    FARPROC MemoryGetProcAddressP(unsigned char*, DWORD32 hash);
    /**
